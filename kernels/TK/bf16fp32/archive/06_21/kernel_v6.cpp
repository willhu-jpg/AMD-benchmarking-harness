...
void micro_tk(const micro_globals g) {
    ...
    auto Ast = subtile_inplace<BLOCK_SIZE, SUB_K_STEP>(As, {0, warp_group_id});
    auto Bst = subtile_inplace<BLOCK_SIZE, SUB_K_STEP>(Bs, {0, warp_group_id});
    ...
    if (num_tiles > 1) {
        load_global_to_registers<2, false, st_subtile<st_bf<BLOCK_SIZE, K_STEP>, BLOCK_SIZE, SUB_K_STEP>, _gl_A, coord<st_subtile<st_bf<BLOCK_SIZE, K_STEP>, BLOCK_SIZE, SUB_K_STEP>>, NUM_THREADS_IN_GROUP>(
            a_buffer_next, BUFFER_SIZE, g.a, {0, 0, row, 2 + warp_group_id}, Ast, a_metadata);
        load_global_to_registers<2, false, st_subtile<st_bf<BLOCK_SIZE, K_STEP>, BLOCK_SIZE, SUB_K_STEP>, _gl_B, coord<st_subtile<st_bf<BLOCK_SIZE, K_STEP>, BLOCK_SIZE, SUB_K_STEP>>, NUM_THREADS_IN_GROUP>(
            b_buffer_next, BUFFER_SIZE, g.b, {0, 0, col, 2 + warp_group_id}, Bst, b_metadata);
    }
    ...
    for (int tile = 0; tile < num_tiles; ++tile) {
        ...
        if (should_load) {
            load_global_to_registers<2, false, st_subtile<st_bf<BLOCK_SIZE, K_STEP>, BLOCK_SIZE, SUB_K_STEP>, _gl_A, coord<st_subtile<st_bf<BLOCK_SIZE, K_STEP>, BLOCK_SIZE, SUB_K_STEP>>, NUM_THREADS_IN_GROUP>(
                a_buffer_next, BUFFER_SIZE, g.a, {0, 0, row, (tile + 1) * 2 + warp_group_id}, Ast, a_metadata);
            
            load_global_to_registers<2, false, st_subtile<st_bf<BLOCK_SIZE, K_STEP>, BLOCK_SIZE, SUB_K_STEP>, _gl_B, coord<st_subtile<st_bf<BLOCK_SIZE, K_STEP>, BLOCK_SIZE, SUB_K_STEP>>, NUM_THREADS_IN_GROUP>(
                b_buffer_next, BUFFER_SIZE, g.b, {0, 0, col, (tile + 1) * 2 + warp_group_id}, Bst, b_metadata);
        }
