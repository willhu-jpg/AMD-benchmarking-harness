...
; %bb.0:
	...
	v_mad_u64_u32 v[6:7], s[10:11], v13, s6, v[12:13]
	v_or_b32_e32 v15, 64, v13
	v_ashrrev_i32_e32 v7, 31, v6
	v_mad_u64_u32 v[10:11], s[10:11], v15, s6, v[12:13]
	...
	;;#ASMEND
	v_mad_u64_u32 v[2:3], s[10:11], v13, s8, v[12:13]
	...
	;;#ASMEND
	v_mad_u64_u32 v[4:5], s[10:11], v15, s8, v[12:13]
	...
	;;#ASMEND
	v_lshl_add_u32 v8, s8, 7, v2
	v_ashrrev_i32_e32 v9, 31, v8
	s_cselect_b32 s7, s22, s23
	v_lshl_add_u64 v[24:25], v[8:9], 1, s[4:5]
	v_or_b32_e32 v3, 0xc0, v13
	v_add_u32_e32 v9, s7, v32
	v_mad_u64_u32 v[12:13], s[10:11], v3, s8, v[12:13]
...
.LBB0_3:                                ;   in Loop: Header=BB0_4 Depth=1
	v_bfi_b32 v138, s23, v138, v138
	v_bfi_b32 v136, s23, v136, v136
	v_bfi_b32 v134, s23, v134, v134
	v_bfi_b32 v132, s23, v132, v132
	v_bfi_b32 v130, s23, v130, v130
	v_bfi_b32 v128, s23, v128, v128
	v_bfi_b32 v126, s23, v126, v126
	v_bfi_b32 v124, s23, v124, v124
	v_bfi_b32 v154, s23, v154, v154
	v_bfi_b32 v152, s23, v152, v152
	v_bfi_b32 v150, s23, v150, v150
	v_bfi_b32 v148, s23, v148, v148
	v_bfi_b32 v146, s23, v146, v146
	v_bfi_b32 v144, s23, v144, v144
	v_bfi_b32 v142, s23, v142, v142
	v_bfi_b32 v140, s23, v140, v140
	s_barrier
...
.LBB0_4:                                ; =>This Inner Loop Header: Depth=1
	s_cmpk_lg_i32 s16, 0x3f80
	s_cselect_b64 s[8:9], -1, 0
	s_cmpk_eq_i32 s16, 0x3f80
	s_cbranch_scc1 .LBB0_6
; %bb.5:                                ;   in Loop: Header=BB0_4 Depth=1
	s_add_u32 s4, s19, s16
	s_addc_u32 s5, s20, s17
	buffer_load_dwordx4 v[62:65], v159, s[4:7], 0 offen
	buffer_load_dwordx4 v[70:73], v158, s[4:7], 0 offen
...
; %bb.7:                                ;   in Loop: Header=BB0_4 Depth=1
	...
	s_addc_u32 s9, s22, s17
	s_mov_b32 s11, s7
	buffer_load_dwordx4 v[66:69], v175, s[8:11], 0 offen
	buffer_load_dwordx4 v[74:77], v176, s[8:11], 0 offen
	buffer_load_dwordx4 v[78:81], v177, s[8:11], 0 offen
	buffer_load_dwordx4 v[86:89], v178, s[8:11], 0 offen
.LBB0_8:                                ;   in Loop: Header=BB0_4 Depth=1
	v_bfi_b32 v106, s23, v106, v106
	v_bfi_b32 v104, s23, v104, v104
	v_bfi_b32 v102, s23, v102, v102
	v_bfi_b32 v100, s23, v100, v100
	v_bfi_b32 v98, s23, v98, v98
	v_bfi_b32 v96, s23, v96, v96
	v_bfi_b32 v94, s23, v94, v94
	v_bfi_b32 v92, s23, v92, v92
	v_bfi_b32 v122, s23, v122, v122
	v_bfi_b32 v120, s23, v120, v120
	v_bfi_b32 v118, s23, v118, v118
	v_bfi_b32 v116, s23, v116, v116
	v_bfi_b32 v114, s23, v114, v114
	v_bfi_b32 v112, s23, v112, v112
	v_bfi_b32 v110, s23, v110, v110
	v_bfi_b32 v108, s23, v108, v108
	; sched_barrier mask(0x00000000)
	;;#ASMSTART
...
.LBB0_12:
	...
	v_mul_lo_u32 v0, v156, s14
	s_waitcnt vmcnt(1)
	v_add_u32_e32 v62, s14, v0
	v_lshl_or_b32 v108, v1, 5, s18
	v_add_u32_e32 v64, s14, v62
	v_lshl_or_b32 v98, s2, 8, v91
	s_mul_i32 s4, s14, s3
	v_mul_lo_u32 v1, s15, v108
	v_mad_u64_u32 v[100:101], s[0:1], s14, v108, 0
	...
	v_lshl_add_u64 v[100:101], v[100:101], 2, s[12:13]
	...
	v_mad_u64_u32 v[76:77], s[0:1], s14, 13, v[66:67]
	...
	v_mad_u64_u32 v[34:35], s[2:3], s14, v34, 0
...
; COMPUTE_PGM_RSRC3_GFX90A:TG_SPLIT: 0
	...
	.type	__hip_cuid_10de5c3b6b55ad3e,@object ; @__hip_cuid_10de5c3b6b55ad3e
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_10de5c3b6b55ad3e
__hip_cuid_10de5c3b6b55ad3e:
	.byte	0                               ; 0x0
	.size	__hip_cuid_10de5c3b6b55ad3e, 1
	...
	.addrsig
	.addrsig_sym __shm
	.addrsig_sym __hip_cuid_10de5c3b6b55ad3e
	.amdgpu_metadata
---
amdhsa.kernels:
  - .agpr_count:     0
