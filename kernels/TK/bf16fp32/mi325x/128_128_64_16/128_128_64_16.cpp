...
void micro_tk(const micro_globals g) {
    ...
    for (int tile = 0; tile < num_tiles; ++tile) {
        ...
        load(a_reg_3[0], subtile_inplace<REG_BLOCK, DOT_SLICE>(As, {warp_row + 6, 0}));
        __builtin_amdgcn_s_barrier();
        __builtin_amdgcn_sched_barrier(0);
        ...
        load(a_reg_3[1], subtile_inplace<REG_BLOCK, DOT_SLICE>(As, {warp_row + 6, 1}));
        __builtin_amdgcn_s_barrier();
        __builtin_amdgcn_sched_barrier(0);
        ...
        load_async_shared_to_register(a_reg_2[0], subtile_inplace<REG_BLOCK, DOT_SLICE>(As, {warp_row + 4, 2}));
        load_async_shared_to_register(a_reg_3[0], subtile_inplace<REG_BLOCK, DOT_SLICE>(As, {warp_row + 6, 2}));
        ...
        load_async_shared_to_register(a_reg_2[1], subtile_inplace<REG_BLOCK, DOT_SLICE>(As, {warp_row + 4, 3}));
        load(a_reg_3[1], subtile_inplace<REG_BLOCK, DOT_SLICE>(As, {warp_row + 6, 3}));
        __builtin_amdgcn_s_barrier();
        __builtin_amdgcn_sched_barrier(0);
