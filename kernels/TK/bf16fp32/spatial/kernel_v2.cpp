...
void micro_tk(const micro_globals g) {
    ...
    wgid = swizzle_chiplet(wgid, NUM_WGS, NUM_XCDS);
    wgid = swizzle_l2_tile_col_major(wgid, num_pid_m, num_pid_n, 16, 16);
    const int row = wgid / num_pid_n; 
    const int col = wgid % num_pid_n; 
